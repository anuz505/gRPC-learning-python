...
class TodoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTodoById = channel.unary_unary(
                ...
                response_deserializer=todo__pb2.GetTodoByIdResponse.FromString,
                _registered_method=True)
...
def add_TodoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTodoById': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=todo__pb2.GetTodoByIdResponse.SerializeToString,
            ),
...
class TodoService(object):
    ...
    def GetTodoById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            todo__pb2.GetTodoByIdResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
